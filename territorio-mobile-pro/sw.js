'use strict';
const VERSION='ct-pro-20260726-3';
const SHELL=[
  './','./index.html','./pro.css','./pro-addon.js','./pro-addon-main.js','./coverage-addon.js','./remote-auth-addon.js','./admin-addon.js','./startup-guard-addon.js','./manifest.webmanifest','./icon.svg',
